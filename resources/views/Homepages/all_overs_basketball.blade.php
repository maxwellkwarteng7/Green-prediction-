        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <h1 class="text-white mb-lg-3 mb-4"><strong>Basketball Overs/Unders</em></strong></h1>
                    <p class="text-black">All your Basketball Overs/Unders here</p>
                    <br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <h2 class="mb-5">Overs/Unders Games</h2>
            </div>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        @foreach($all_overs_basketball as $win)
                        <tr>
                          <td>{{$win->game}}</td>
                          <td>{{$win->league}}</td>
                          <td>{{$win->time}}</td>
                  ...
                  <div class="p-2">
                    {{$all_overs_basketball->links()}}
                  </div>
                  <div class="text-center p-2">
                    <a class="btn btn-outline-dark btn-sm" href="{{url('nba_home')}}">Go back</a>
                  </div>
