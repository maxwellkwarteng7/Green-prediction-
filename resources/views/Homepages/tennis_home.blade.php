        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <h1 class="text-white mb-lg-3 mb-4"><strong>Tennis Games</em></strong></h1>
                    <p class="text-black">Get all Tennis predictions here</p>
                    <br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <h2 class="mb-5">Tennis Games</h2>
            </div>
            @if(count($tennis_straight)>0)
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        @foreach($tennis_straight->take(3) as $win)
                        <tr>
                          <td>{{$win->game}}</td>
                          <td>{{$win->league}}</td>
                          <td>{{$win->time}}</td>
                  ...
                  <div class="text-center p-2">
                    <a class="btn btn-outline-dark btn-sm" href="{{url('all_straight_tennis')}}">view all</a>
                  </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="price-list-thumb-wrap">
                    <div class="mb-4">
                        <h2 class="mb-2">Tennis matches</h2>
                    ...
                    <div class="price-list-thumb">
                        <h6 class="d-flex">
                           Straight win
                            ...
                            <strong>{{$tennis_straight_count}}</strong>
                        </h6>
                    </div>
            ...
            <div class="col-lg-4 col-12 custom-block-bg-overlay-wrap mt-5 mb-5 mb-lg-0 mt-lg-0 pt-3 pt-lg-0">
                <img style="width:450px; height:400px;" src="tennis/images/four.jpg" class="custom-block-bg-overlay-image img-fluid" alt="">
            </div>
...
<!-- JAVASCRIPT FILES -->
<script src="tennis/js/jquery.min.js"></script>
<script src="tennis/js/bootstrap.min.js"></script>
<script src="tennis/js/click-scroll.js"></script>
<script src="tennis/js/custom.js"></script>
