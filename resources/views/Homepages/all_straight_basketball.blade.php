        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-12">
                    <h1 class="text-white mb-lg-3 mb-4"><strong>Basketball straight wins</em></strong></h1>
                    <p class="text-black">All your straight wins basketball games here</p>
                    <br>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        @foreach($all_straight_basketball as $win)
                        <tr>
                          <td>{{$win->game}}</td>
                          <td>{{$win->league}}</td>
                          <td>{{$win->time}}</td>
