        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="text-center p-5">
              <form class="" action="{{url('/search_straight_wins')}}" method="get">
                @csrf
                <div class="d-flex">
                  <div class="p-2">
                    <input type="text" name="search_wins" placeholder="Search a match" class="text-dark">
                  </div>
                  <div class="p-3">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        @endif
                          ...
                          <td>
                            <a onclick="confirmation(event)" href="{{url('/remove_football_straight',$win->id)}}" class="btn btn-danger btn-rounded btn-sm">Delete</a>
                          </td>
