        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="text-center p-5">
              <form class="" action="{{url('/search_basket_overs')}}" method="get">
                @csrf
                <div class="d-flex">
                  <div class="p-2">
                    <input type="text" name="search" placeholder="Search overs/unders match" class="text-dark">
                  </div>
                  <div class="p-3">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">All Overs/Unders</h3>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        @endif
                          ...
                          <td>
                            <a onclick="confirmation(event)"  href="{{url('/delete_over_basketball',$win->id)}}" class="btn btn-danger btn-rounded btn-sm">Delete</a>
                          </td>
                        </tr>
                      @endforeach
                      </tbody>
