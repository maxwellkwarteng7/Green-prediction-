          ...
          <div class="content-wrapper">
            ...
            <div class="row" style="margin:auto;">
              <div class="col-lg-8 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">Add scorer game here</h3>
                    <div class="p-2">
                      <form action="{{url('/save_scorer_game')}}" method="post">
                        <style media="screen">
                          label{
                            width:100px;
                          }
                        ...
                        <div class="p-2">
                          <label>Scorer: </label>
                          <input class="text-dark"type="text" name="scorer" placeholder="Enter prediction" required>
                        </div>
                        <div class="p-2">
                          <label>Odds :</label>
