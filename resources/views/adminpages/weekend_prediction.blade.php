        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="text-center p-5">
              <form class="" action="{{url('/search_predictions')}}" method="get">
                @csrf
                <div class="d-flex">
                  <div class="p-2">
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">All Weekend Prediction</h3>
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <div class="p-3 text-center">
                        <a onclick="confirmation(event)" href="{{url('/delete_all_weekend')}}" class="btn btn-danger btn-lg">Delete all</a>
                        <p>This button deletes all weekend prediction games</p>
                      </div>
                    </table>
                    <div class="p-2">
                      {{$predictions->links()}}
